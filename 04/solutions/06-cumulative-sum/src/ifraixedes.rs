...
//!
//! It has to support opts::Add because we are summing the items of the iterator.

use std::iter::Iterator;
use std::ops::Add;

// struct CumulativeSum;
struct CumulativeSum<C, I>
where
    C: Iterator<Item= I>,
    I: Add<Output = I>,
{
...
impl<C, I> Iterator for CumulativeSum<C, I>
where
    C: Iterator<Item= I>,
    I: Add<Output = I> + Copy,
{
    ...
    fn next(&mut self) -> Option<Self::Item> {
        ...
        self.prev = Some(self.prev.map_or(current, |p| current +  p));
        self.prev
    }
}
